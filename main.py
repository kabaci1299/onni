...
photologo = 'https://postimage.me/images/2026/01/26/2d738c.md.jpg' #https://envs.sh/fH.jpg/IMG20250803719.jpg
...
image_urls = [
    "https://postimage.me/images/2026/01/26/2d738c.md.jpg",
    "https://postimage.me/images/2026/01/26/2d738c.md.jpg",
    "https://postimage.me/images/2026/01/26/2d738c.md.jpg",
...
async def txt_handler(bot: Client, m: Message):  
    ...
    f"**Extracted Bʏ : {CR}**\n"
                ...
                if "drive" in url:
                    ...
                    Show = f"<i><b>Fast Video dr Downloading</b></i>\n<blockquote><b>{str(count).zfill(3)}) {name1}</b></blockquote>"
                    prog = await bot.send_message(channel_id, Show, disable_web_page_preview=True)
                    ...
                    Show = f"<i><b>Fast Video E Downloading</b></i>\n<blockquote><b>{str(count).zfill(3)}) {name1}</b></blockquote>"
                    prog = await bot.send_message(channel_id, Show, disable_web_page_preview=True)
